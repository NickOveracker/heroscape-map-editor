...
import { isEvergreenTree, isJungleTerrainHex } from '../utils/board-utils'
    ...
    >
      ...
      {(isJungleTerrainHex(hex.terrain)) &&
        <Text
          ...
          x={pieceHeightText.toString().length === 2 ? 0.4 * SVG_HEX_APOTHEM : 0.7 * SVG_HEX_APOTHEM}
        >
          {pieceHeightText}
        </Text>
      }
