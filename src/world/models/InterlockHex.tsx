...
function InterlockHex0({ color, isFluid, children }: PropsWithChildren<{ color: string, isFluid: boolean }>) {
...
function InterlockHex1({ color, isFluid, children }: PropsWithChildren<{ color: string, isFluid: boolean }>) {
